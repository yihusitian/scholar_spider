...
public class OnlinelibraryWileyAbstractAdaptor extends AbstractAdaptor {

    private static final String SITE_URL = "onlinelibrary.wiley.com";

    //去查header信息, https://onlinelibrary.wiley.com/doi/abs/10.1111/j.1360-0443.1988.tb02551.x
    private static final Map<String, String> HEADERS = new HashMap<String, String>() {{
        this.put("authority","onlinelibrary.wiley.com");
    ...
    public OnlinelibraryWileyAbstractAdaptor(String dirName) {
        super(dirName);
    }
