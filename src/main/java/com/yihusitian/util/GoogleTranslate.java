 ...
 * <p>
 * 原文链接：https://blog.csdn.net/m0_57556230/article/details/121995475
 */
public class GoogleTranslate {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(translateEnglishToCn(txt));
    }
    ...
    public String translateText(String text, String sourceLang, String targetLang) throws Exception {
        ...
        for (Iterator<Object> it = jsonArray.getJSONArray(0).iterator(); it.hasNext(); ) {
